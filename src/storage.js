...
/**
 */
DHTStorage.prototype.putImmutable_ = async function(data) {
...
/**
 */
DHTStorage.prototype.handleQuery_ = function(method, args, node, respond) {
  try {
 ...
 * @private
 */
DHTStorage.prototype.handleGetQuery_ = function(args, node) {
  const stored = this.store_.get(args.target);
  const nodes = this.dht_.nodes_.closest(args.target, this.dht_.K_);
 ...
 * @private
 */
DHTStorage.prototype.handlePutQuery_ = function(args, node) {
